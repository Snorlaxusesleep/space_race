...
HD_PWD='C:/Users/user/Documents/.git/space_race/lab05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CENG3430.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CENG3430.tcl -notrace
