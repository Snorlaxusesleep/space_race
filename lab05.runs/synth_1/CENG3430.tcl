...
synth_design -top CENG3430 -part xc7z020clg484-1


write_checkpoint -force -noxdef CENG3430.dcp

catch { report_utilization -file CENG3430_utilization_synth.rpt -pb CENG3430_utilization_synth.pb }
