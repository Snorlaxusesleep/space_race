...
HD_PWD='C:/Users/user/Documents/.git/space_race/lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CENG3430.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CENG3430.tcl
